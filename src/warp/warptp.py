...
def goHorizon():
  sz,fs = resampleWithXY(logs,curve)
  ...
  dx = (xmax - xmin)/(nl)
  dy = (ymax - ymin)/(nl)
  sx = Sampling(nl,dx,xmin)
  sy = Sampling(nl,dy,ymin)


  ng = NearestGridder3(ft,zt,x,y)
  grid = ng.grid(sz,sx,sy
